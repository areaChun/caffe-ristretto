...
#vgg16
#threshold = {'conv5_1': 0.00289, 'fc6': 0.00068, 'conv5_3': 0.00608, 'conv5_2': 0.0038, 'fc8': 0.00077, 'fc7': 0.0008, 'conv4_1': 0.00582, 'conv4_2': 0.00439, 'conv4_3': 0.00452, 'conv3_3': 0.00393, 'conv3_2': 0.00454, 'conv3_1': 0.00654, 'conv1_1': 0.08292, 'conv1_2': 0.01003, 'conv2_2': 0.00752, 'conv2_1': 0.01574}
# threshold = {'conv1_1': 0.08292,'conv1_2': 0.01003,\
# 			'conv2_2': 0.00752, 'conv2_1': 0.01574,\
# 			'conv3_1': 0.00654,'conv3_2': 0.00454,'conv3_3': 0.00393,\
# 			'conv4_1': 0.00582,'conv4_2': 0.00439, 'conv4_3': 0.00452,\
# 			'conv5_1': 0.00289,'conv5_2': 0.0038,'conv5_3': 0.00608,  \
# 			'fc6': 0.00405,'fc7': 0.00703,'fc8': 0.00878}
#vgg19
# threshold = {'conv5_4': 0.00542, 'conv5_1': 0.00019, 'fc6': 0.00165, 'conv5_3': 0.00614, 'conv5_2': 0.00614, 'fc8': 0.00378, 'fc7': 0.0043, 'conv4_1': 0.00403, 'conv4_2': 0.00102, 'conv4_3': 0.00281, 'conv4_4': 0.00037, 'conv3_4': 0.00446, 'conv3_3': 0.00531, 'conv3_2': 0.00634, 'conv3_1': 0.00214, 'conv1_1': 0.0455, 'conv1_2': 0.03204, 'conv2_2': 0.00552, 'conv2_1': 0.00818}
threshold = {'conv1_1': 0.0455,'conv1_2': 0.01404,\
			'conv2_1': 0.00818, 'conv2_2': 0.00552,\
			'conv3_1': 0.00514,'conv3_2': 0.00534,'conv3_3': 0.00431,'conv3_4': 0.00446,\
			'conv4_1': 0.00403,'conv4_2': 0.00302, 'conv4_3': 0.00281,'conv4_4': 0.00337,\
			'conv5_1': 0.00319,'conv5_2': 0.00514,'conv5_3': 0.00514,'conv5_4': 0.00442, \
			'fc6': 0.00325,'fc7': 0.007,'fc8': 0.00768}
# threshold = {'conv1_1': 0,'conv1_2': 0,\
# 			'conv2_2': 0, 'conv2_1': 0,\
# 			'conv3_1': 0,'conv3_2': 0,'conv3_3': 0,\
# 			'conv4_1': 0,'conv4_2': 0, 'conv4_3': 0,\
# 			'conv5_1': 0,'conv5_2': 0,'conv5_3': 0,  \
# 			'fc6': 0.00285,'fc7': 0.0063,'fc8': 0.00778}
#num_pruned = 0 
amount_pruned = 0
amount_weight = 0
dict_pre = {}
