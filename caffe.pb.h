...
enum QuantizationParameter_Precision {
...
const QuantizationParameter_Precision QuantizationParameter_Precision_Precision_MIN = QuantizationParameter_Precision_DYNAMIC_FIXED_POINT;
const QuantizationParameter_Precision QuantizationParameter_Precision_Precision_MAX = QuantizationParameter_Precision_INTEGER_POWER_OF_2_WEIGHTS;
const int QuantizationParameter_Precision_Precision_ARRAYSIZE = QuantizationParameter_Precision_Precision_MAX + 1;

const ::google::protobuf::EnumDescriptor* QuantizationParameter_Precision_descriptor();
inline const ::std::string& QuantizationParameter_Precision_Name(QuantizationParameter_Precision value) {
  return ::google::protobuf::internal::NameOfEnum(
    QuantizationParameter_Precision_descriptor(), value);
}
inline bool QuantizationParameter_Precision_Parse(
    const ::std::string& name, QuantizationParameter_Precision* value) {
  return ::google::protobuf::internal::ParseNamedEnum<QuantizationParameter_Precision>(
    QuantizationParameter_Precision_descriptor(), name, value);
}
enum QuantizationParameter_Rounding {
...
const QuantizationParameter_Rounding QuantizationParameter_Rounding_Rounding_MIN = QuantizationParameter_Rounding_NEAREST;
const QuantizationParameter_Rounding QuantizationParameter_Rounding_Rounding_MAX = QuantizationParameter_Rounding_STOCHASTIC;
const int QuantizationParameter_Rounding_Rounding_ARRAYSIZE = QuantizationParameter_Rounding_Rounding_MAX + 1;

const ::google::protobuf::EnumDescriptor* QuantizationParameter_Rounding_descriptor();
inline const ::std::string& QuantizationParameter_Rounding_Name(QuantizationParameter_Rounding value) {
  return ::google::protobuf::internal::NameOfEnum(
    QuantizationParameter_Rounding_descriptor(), value);
}
inline bool QuantizationParameter_Rounding_Parse(
    const ::std::string& name, QuantizationParameter_Rounding* value) {
  return ::google::protobuf::internal::ParseNamedEnum<QuantizationParameter_Rounding>(
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.QuantizationParameter quantization_param = 147;
  inline bool has_quantization_param() const;
  inline void clear_quantization_param();
  static const int kQuantizationParamFieldNumber = 147;
  inline const ::caffe::QuantizationParameter& quantization_param() const;
  inline ::caffe::QuantizationParameter* mutable_quantization_param();
  inline ::caffe::QuantizationParameter* release_quantization_param();
  inline void set_allocated_quantization_param(::caffe::QuantizationParameter* quantization_param);
 ...
 private:
  ...
  inline void set_has_quantization_param();
  inline void clear_has_quantization_param();
...
class QuantizationParameter : public ::google::protobuf::Message {
 public:
  QuantizationParameter();
  virtual ~QuantizationParameter();
  ...
  void Swap(QuantizationParameter* other);

  // implements Message ----------------------------------------------

  QuantizationParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  static const Precision DYNAMIC_FIXED_POINT = QuantizationParameter_Precision_DYNAMIC_FIXED_POINT;
  static const Precision MINIFLOAT = QuantizationParameter_Precision_MINIFLOAT;
  static const Precision INTEGER_POWER_OF_2_WEIGHTS = QuantizationParameter_Precision_INTEGER_POWER_OF_2_WEIGHTS;
  ...
  static inline const ::std::string& Precision_Name(Precision value) {
    return QuantizationParameter_Precision_Name(value);
  }
  ...
  static const Rounding NEAREST = QuantizationParameter_Rounding_NEAREST;
  static const Rounding STOCHASTIC = QuantizationParameter_Rounding_STOCHASTIC;
  static inline bool Rounding_IsValid(int value) {
    return QuantizationParameter_Rounding_IsValid(value);
  }
  static const Rounding Rounding_MIN =
    QuantizationParameter_Rounding_Rounding_MIN;
  static const Rounding Rounding_MAX =
    QuantizationParameter_Rounding_Rounding_MAX;
  static const int Rounding_ARRAYSIZE =
    QuantizationParameter_Rounding_Rounding_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Rounding_descriptor() {
    return QuantizationParameter_Rounding_descriptor();
  }
  static inline const ::std::string& Rounding_Name(Rounding value) {
    return QuantizationParameter_Rounding_Name(value);
  }
  static inline bool Rounding_Parse(const ::std::string& name,
      Rounding* value) {
  ...
  inline ::caffe::QuantizationParameter_Precision precision() const;
  inline void set_precision(::caffe::QuantizationParameter_Precision value);

  // optional .caffe.QuantizationParameter.Rounding rounding_scheme = 2 [default = NEAREST];
  inline bool has_rounding_scheme() const;
  inline void clear_rounding_scheme();
  static const int kRoundingSchemeFieldNumber = 2;
  inline ::caffe::QuantizationParameter_Rounding rounding_scheme() const;
  inline void set_rounding_scheme(::caffe::QuantizationParameter_Rounding value);

  // optional uint32 bw_layer_in = 3 [default = 32];
  inline bool has_bw_layer_in() const;
  inline void clear_bw_layer_in();
  static const int kBwLayerInFieldNumber = 3;
  inline ::google::protobuf::uint32 bw_layer_in() const;
  inline void set_bw_layer_in(::google::protobuf::uint32 value);

  // optional uint32 bw_layer_out = 4 [default = 32];
  inline bool has_bw_layer_out() const;
  inline void clear_bw_layer_out();
  static const int kBwLayerOutFieldNumber = 4;
  inline ::google::protobuf::uint32 bw_layer_out() const;
  inline void set_bw_layer_out(::google::protobuf::uint32 value);

  // optional uint32 bw_params = 5 [default = 32];
  inline bool has_bw_params() const;
  inline void clear_bw_params();
  static const int kBwParamsFieldNumber = 5;
  inline ::google::protobuf::uint32 bw_params() const;
  inline void set_bw_params(::google::protobuf::uint32 value);

  // optional uint32 bw_mean = 6 [default = 32];
  inline bool has_bw_mean() const;
  inline void clear_bw_mean();
  static const int kBwMeanFieldNumber = 6;
  inline ::google::protobuf::uint32 bw_mean() const;
  inline void set_bw_mean(::google::protobuf::uint32 value);

  // optional uint32 bw_var = 7 [default = 32];
  inline bool has_bw_var() const;
  inline void clear_bw_var();
  static const int kBwVarFieldNumber = 7;
  inline ::google::protobuf::uint32 bw_var() const;
  inline void set_bw_var(::google::protobuf::uint32 value);

  // optional uint32 bw_mov = 8 [default = 32];
  inline bool has_bw_mov() const;
  inline void clear_bw_mov();
  static const int kBwMovFieldNumber = 8;
  inline ::google::protobuf::uint32 bw_mov() const;
  inline void set_bw_mov(::google::protobuf::uint32 value);

  // optional int32 fl_layer_in = 9 [default = 16];
  inline bool has_fl_layer_in() const;
  inline void clear_fl_layer_in();
  static const int kFlLayerInFieldNumber = 9;
  inline ::google::protobuf::int32 fl_layer_in() const;
  inline void set_fl_layer_in(::google::protobuf::int32 value);

  // optional int32 fl_layer_out = 10 [default = 16];
  inline bool has_fl_layer_out() const;
  inline void clear_fl_layer_out();
  static const int kFlLayerOutFieldNumber = 10;
  inline ::google::protobuf::int32 fl_layer_out() const;
  inline void set_fl_layer_out(::google::protobuf::int32 value);

  // optional int32 fl_params = 11 [default = 16];
  inline bool has_fl_params() const;
  inline void clear_fl_params();
  static const int kFlParamsFieldNumber = 11;
  inline ::google::protobuf::int32 fl_params() const;
  inline void set_fl_params(::google::protobuf::int32 value);

  // optional int32 fl_mean = 12 [default = 16];
  inline bool has_fl_mean() const;
  inline void clear_fl_mean();
  static const int kFlMeanFieldNumber = 12;
  inline ::google::protobuf::int32 fl_mean() const;
  inline void set_fl_mean(::google::protobuf::int32 value);

  // optional int32 fl_var = 13 [default = 16];
  inline bool has_fl_var() const;
  inline void clear_fl_var();
  static const int kFlVarFieldNumber = 13;
  inline ::google::protobuf::int32 fl_var() const;
  inline void set_fl_var(::google::protobuf::int32 value);

  // optional int32 fl_mov = 14 [default = 16];
  inline bool has_fl_mov() const;
  inline void clear_fl_mov();
  static const int kFlMovFieldNumber = 14;
  inline ::google::protobuf::int32 fl_mov() const;
  inline void set_fl_mov(::google::protobuf::int32 value);

  // optional uint32 mant_bits = 15 [default = 23];
  inline bool has_mant_bits() const;
  inline void clear_mant_bits();
  static const int kMantBitsFieldNumber = 15;
  inline ::google::protobuf::uint32 mant_bits() const;
  inline void set_mant_bits(::google::protobuf::uint32 value);

  // optional uint32 exp_bits = 16 [default = 8];
  inline bool has_exp_bits() const;
  inline void clear_exp_bits();
  static const int kExpBitsFieldNumber = 16;
  inline ::google::protobuf::uint32 exp_bits() const;
  inline void set_exp_bits(::google::protobuf::uint32 value);

  // optional int32 exp_min = 17 [default = -8];
  inline bool has_exp_min() const;
  inline void clear_exp_min();
  static const int kExpMinFieldNumber = 17;
  inline ::google::protobuf::int32 exp_min() const;
  inline void set_exp_min(::google::protobuf::int32 value);

  // optional int32 exp_max = 18 [default = -1];
  inline bool has_exp_max() const;
  inline void clear_exp_max();
  static const int kExpMaxFieldNumber = 18;
 ...
 private:
  ...
  inline void set_has_rounding_scheme();
  inline void clear_has_rounding_scheme();
  inline void set_has_bw_layer_in();
  inline void clear_has_bw_layer_in();
  inline void set_has_bw_layer_out();
  inline void clear_has_bw_layer_out();
  inline void set_has_bw_params();
  inline void clear_has_bw_params();
  inline void set_has_bw_mean();
  inline void clear_has_bw_mean();
  inline void set_has_bw_var();
  inline void clear_has_bw_var();
  inline void set_has_bw_mov();
  inline void clear_has_bw_mov();
  inline void set_has_fl_layer_in();
  inline void clear_has_fl_layer_in();
  inline void set_has_fl_layer_out();
  inline void clear_has_fl_layer_out();
  inline void set_has_fl_params();
  inline void clear_has_fl_params();
  inline void set_has_fl_mean();
  inline void clear_has_fl_mean();
  inline void set_has_fl_var();
  inline void clear_has_fl_var();
  inline void set_has_fl_mov();
  inline void clear_has_fl_mov();
  inline void set_has_mant_bits();
  inline void clear_has_mant_bits();
  inline void set_has_exp_bits();
  inline void clear_has_exp_bits();
  inline void set_has_exp_min();
  inline void clear_has_exp_min();
  ...
  ::google::protobuf::uint32 bw_layer_in_;
  ::google::protobuf::uint32 bw_layer_out_;
  ::google::protobuf::uint32 bw_params_;
  ::google::protobuf::uint32 bw_mean_;
  ::google::protobuf::uint32 bw_var_;
  ::google::protobuf::uint32 bw_mov_;
  ::google::protobuf::int32 fl_layer_in_;
  ::google::protobuf::int32 fl_layer_out_;
  ::google::protobuf::int32 fl_params_;
  ::google::protobuf::int32 fl_mean_;
  ::google::protobuf::int32 fl_var_;
  ::google::protobuf::int32 fl_mov_;
  ::google::protobuf::uint32 mant_bits_;
  ::google::protobuf::uint32 exp_bits_;
  ::google::protobuf::int32 exp_min_;
  ...
  void InitAsDefaultInstance();
  static QuantizationParameter* default_instance_;
};
// -------------------------------------------------------------------
...
inline void LayerParameter::set_has_quantization_param() {
  _has_bits_[1] |= 0x00002000u;
}
inline void LayerParameter::clear_has_quantization_param() {
  _has_bits_[1] &= ~0x00002000u;
}
inline void LayerParameter::clear_quantization_param() {
  if (quantization_param_ != NULL) quantization_param_->::caffe::QuantizationParameter::Clear();
  clear_has_quantization_param();
}
inline const ::caffe::QuantizationParameter& LayerParameter::quantization_param() const {
  return quantization_param_ != NULL ? *quantization_param_ : *default_instance_->quantization_param_;
}
inline ::caffe::QuantizationParameter* LayerParameter::mutable_quantization_param() {
  set_has_quantization_param();
  if (quantization_param_ == NULL) quantization_param_ = new ::caffe::QuantizationParameter;
...
inline void QuantizationParameter::set_has_precision() {
  _has_bits_[0] |= 0x00000001u;
}
inline void QuantizationParameter::clear_has_precision() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void QuantizationParameter::set_has_rounding_scheme() {
  _has_bits_[0] |= 0x00000002u;
}
inline void QuantizationParameter::clear_has_rounding_scheme() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void QuantizationParameter::clear_rounding_scheme() {
  rounding_scheme_ = 0;
  clear_has_rounding_scheme();
}
...
inline void QuantizationParameter::set_has_bw_layer_in() {
  _has_bits_[0] |= 0x00000004u;
}
inline void QuantizationParameter::clear_has_bw_layer_in() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void QuantizationParameter::clear_bw_layer_in() {
  bw_layer_in_ = 32u;
  clear_has_bw_layer_in();
}
inline ::google::protobuf::uint32 QuantizationParameter::bw_layer_in() const {
  return bw_layer_in_;
}
inline void QuantizationParameter::set_bw_layer_in(::google::protobuf::uint32 value) {
  set_has_bw_layer_in();
  bw_layer_in_ = value;
}
...
inline void QuantizationParameter::set_has_bw_layer_out() {
  _has_bits_[0] |= 0x00000008u;
}
inline void QuantizationParameter::clear_has_bw_layer_out() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void QuantizationParameter::clear_bw_layer_out() {
  bw_layer_out_ = 32u;
  clear_has_bw_layer_out();
}
inline ::google::protobuf::uint32 QuantizationParameter::bw_layer_out() const {
  return bw_layer_out_;
}
inline void QuantizationParameter::set_bw_layer_out(::google::protobuf::uint32 value) {
  set_has_bw_layer_out();
  bw_layer_out_ = value;
}
...
inline void QuantizationParameter::set_has_bw_params() {
  _has_bits_[0] |= 0x00000010u;
}
inline void QuantizationParameter::clear_has_bw_params() {
  _has_bits_[0] &= ~0x00000010u;
}
...
inline ::google::protobuf::uint32 QuantizationParameter::bw_params() const {
  return bw_params_;
}
inline void QuantizationParameter::set_bw_params(::google::protobuf::uint32 value) {
  set_has_bw_params();
  bw_params_ = value;
}

// optional uint32 bw_mean = 6 [default = 32];
inline bool QuantizationParameter::has_bw_mean() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void QuantizationParameter::set_has_bw_mean() {
  _has_bits_[0] |= 0x00000020u;
}
inline void QuantizationParameter::clear_has_bw_mean() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void QuantizationParameter::clear_bw_mean() {
  bw_mean_ = 32u;
  clear_has_bw_mean();
}
inline ::google::protobuf::uint32 QuantizationParameter::bw_mean() const {
  return bw_mean_;
}
inline void QuantizationParameter::set_bw_mean(::google::protobuf::uint32 value) {
  set_has_bw_mean();
  bw_mean_ = value;
}

// optional uint32 bw_var = 7 [default = 32];
inline bool QuantizationParameter::has_bw_var() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void QuantizationParameter::set_has_bw_var() {
  _has_bits_[0] |= 0x00000040u;
}
inline void QuantizationParameter::clear_has_bw_var() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void QuantizationParameter::clear_bw_var() {
  bw_var_ = 32u;
  clear_has_bw_var();
}
inline ::google::protobuf::uint32 QuantizationParameter::bw_var() const {
  return bw_var_;
}
inline void QuantizationParameter::set_bw_var(::google::protobuf::uint32 value) {
  set_has_bw_var();
  bw_var_ = value;
}

// optional uint32 bw_mov = 8 [default = 32];
inline bool QuantizationParameter::has_bw_mov() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void QuantizationParameter::set_has_bw_mov() {
  _has_bits_[0] |= 0x00000080u;
}
inline void QuantizationParameter::clear_has_bw_mov() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void QuantizationParameter::clear_bw_mov() {
  bw_mov_ = 32u;
  clear_has_bw_mov();
}
inline ::google::protobuf::uint32 QuantizationParameter::bw_mov() const {
  return bw_mov_;
}
inline void QuantizationParameter::set_bw_mov(::google::protobuf::uint32 value) {
  set_has_bw_mov();
  bw_mov_ = value;
}

// optional int32 fl_layer_in = 9 [default = 16];
inline bool QuantizationParameter::has_fl_layer_in() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void QuantizationParameter::set_has_fl_layer_in() {
  _has_bits_[0] |= 0x00000100u;
}
inline void QuantizationParameter::clear_has_fl_layer_in() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void QuantizationParameter::clear_fl_layer_in() {
  fl_layer_in_ = 16;
  clear_has_fl_layer_in();
}
inline ::google::protobuf::int32 QuantizationParameter::fl_layer_in() const {
  return fl_layer_in_;
}
inline void QuantizationParameter::set_fl_layer_in(::google::protobuf::int32 value) {
  set_has_fl_layer_in();
  fl_layer_in_ = value;
}

// optional int32 fl_layer_out = 10 [default = 16];
inline bool QuantizationParameter::has_fl_layer_out() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void QuantizationParameter::set_has_fl_layer_out() {
  _has_bits_[0] |= 0x00000200u;
}
inline void QuantizationParameter::clear_has_fl_layer_out() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void QuantizationParameter::clear_fl_layer_out() {
  fl_layer_out_ = 16;
  clear_has_fl_layer_out();
}
inline ::google::protobuf::int32 QuantizationParameter::fl_layer_out() const {
  return fl_layer_out_;
}
inline void QuantizationParameter::set_fl_layer_out(::google::protobuf::int32 value) {
  set_has_fl_layer_out();
  fl_layer_out_ = value;
}

// optional int32 fl_params = 11 [default = 16];
inline bool QuantizationParameter::has_fl_params() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void QuantizationParameter::set_has_fl_params() {
  _has_bits_[0] |= 0x00000400u;
}
inline void QuantizationParameter::clear_has_fl_params() {
  _has_bits_[0] &= ~0x00000400u;
}
...
inline ::google::protobuf::int32 QuantizationParameter::fl_params() const {
  return fl_params_;
}
inline void QuantizationParameter::set_fl_params(::google::protobuf::int32 value) {
  set_has_fl_params();
  fl_params_ = value;
}

// optional int32 fl_mean = 12 [default = 16];
inline bool QuantizationParameter::has_fl_mean() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void QuantizationParameter::set_has_fl_mean() {
  _has_bits_[0] |= 0x00000800u;
}
inline void QuantizationParameter::clear_has_fl_mean() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void QuantizationParameter::clear_fl_mean() {
  fl_mean_ = 16;
  clear_has_fl_mean();
}
inline ::google::protobuf::int32 QuantizationParameter::fl_mean() const {
  return fl_mean_;
}
inline void QuantizationParameter::set_fl_mean(::google::protobuf::int32 value) {
  set_has_fl_mean();
  fl_mean_ = value;
}

// optional int32 fl_var = 13 [default = 16];
inline bool QuantizationParameter::has_fl_var() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void QuantizationParameter::set_has_fl_var() {
  _has_bits_[0] |= 0x00001000u;
}
inline void QuantizationParameter::clear_has_fl_var() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void QuantizationParameter::clear_fl_var() {
  fl_var_ = 16;
  clear_has_fl_var();
}
inline ::google::protobuf::int32 QuantizationParameter::fl_var() const {
  return fl_var_;
}
inline void QuantizationParameter::set_fl_var(::google::protobuf::int32 value) {
  set_has_fl_var();
  fl_var_ = value;
}

// optional int32 fl_mov = 14 [default = 16];
inline bool QuantizationParameter::has_fl_mov() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void QuantizationParameter::set_has_fl_mov() {
  _has_bits_[0] |= 0x00002000u;
}
inline void QuantizationParameter::clear_has_fl_mov() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void QuantizationParameter::clear_fl_mov() {
  fl_mov_ = 16;
  clear_has_fl_mov();
}
inline ::google::protobuf::int32 QuantizationParameter::fl_mov() const {
  return fl_mov_;
}
inline void QuantizationParameter::set_fl_mov(::google::protobuf::int32 value) {
  set_has_fl_mov();
  fl_mov_ = value;
}

// optional uint32 mant_bits = 15 [default = 23];
inline bool QuantizationParameter::has_mant_bits() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void QuantizationParameter::set_has_mant_bits() {
  _has_bits_[0] |= 0x00004000u;
}
inline void QuantizationParameter::clear_has_mant_bits() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void QuantizationParameter::clear_mant_bits() {
  mant_bits_ = 23u;
  clear_has_mant_bits();
}
inline ::google::protobuf::uint32 QuantizationParameter::mant_bits() const {
  return mant_bits_;
}
inline void QuantizationParameter::set_mant_bits(::google::protobuf::uint32 value) {
  set_has_mant_bits();
  mant_bits_ = value;
}

// optional uint32 exp_bits = 16 [default = 8];
inline bool QuantizationParameter::has_exp_bits() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void QuantizationParameter::set_has_exp_bits() {
  _has_bits_[0] |= 0x00008000u;
}
inline void QuantizationParameter::clear_has_exp_bits() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void QuantizationParameter::clear_exp_bits() {
  exp_bits_ = 8u;
  clear_has_exp_bits();
}
inline ::google::protobuf::uint32 QuantizationParameter::exp_bits() const {
  return exp_bits_;
}
inline void QuantizationParameter::set_exp_bits(::google::protobuf::uint32 value) {
  set_has_exp_bits();
  exp_bits_ = value;
}

// optional int32 exp_min = 17 [default = -8];
inline bool QuantizationParameter::has_exp_min() const {
  return (_has_bits_[0] & 0x00010000u) != 0;
}
inline void QuantizationParameter::set_has_exp_min() {
  _has_bits_[0] |= 0x00010000u;
}
inline void QuantizationParameter::clear_has_exp_min() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void QuantizationParameter::clear_exp_min() {
  exp_min_ = -8;
  clear_has_exp_min();
}
inline ::google::protobuf::int32 QuantizationParameter::exp_min() const {
  return exp_min_;
}
inline void QuantizationParameter::set_exp_min(::google::protobuf::int32 value) {
  set_has_exp_min();
  exp_min_ = value;
}

// optional int32 exp_max = 18 [default = -1];
inline bool QuantizationParameter::has_exp_max() const {
  return (_has_bits_[0] & 0x00020000u) != 0;
}
inline void QuantizationParameter::set_has_exp_max() {
  _has_bits_[0] |= 0x00020000u;
}
inline void QuantizationParameter::clear_has_exp_max() {
  _has_bits_[0] &= ~0x00020000u;
}
inline void QuantizationParameter::clear_exp_max() {
  exp_max_ = -1;
  clear_has_exp_max();
}
inline ::google::protobuf::int32 QuantizationParameter::exp_max() const {
  return exp_max_;
}
inline void QuantizationParameter::set_exp_max(::google::protobuf::int32 value) {
  set_has_exp_max();
  exp_max_ = value;
}
